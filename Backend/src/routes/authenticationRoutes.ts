...
// --- User Registration ---
// Note: This is a basic registration. 
// You must set up a 'profiles' table in Supabase.
router.post('/register', async (req: Request, res: Response) => {
  ...
  // 2. Create a corresponding profile in your public 'profiles' table
  // This is where you store public data like 'role'
